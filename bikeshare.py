...
def time_stats(df):
    ...
    if month != 0:
        print("To see the most common month, please choose 'All' when selecting which month of data.")
    else:
    ...
    if day != 'all':
        print("To see the most common day, please choose 'All' when selecting which day of data")
    else:
